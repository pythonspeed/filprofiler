...
<br>
<blockquote><strong>Need help, or does something look wrong?</strong> <a href="https://pythonspeed.com/fil/docs/">Read the documentation</a>, and if that doesn't help please <a href="https://github.com/pythonspeed/filprofiler/issues/new?body={bugreport}">file an issue</a> and I'll try to help.</blockquote>
<br>
...
<br>
<blockquote><strong>Want memory profiling for your production batch jobs?</strong> I'm working on a <a href="https://pythonspeed.com/fil/docs/fil4prod/difference-opensource.html">commercial version of Fil</a> fast and robust enough to run in production; <a href="mailto:itamar@pythonspeed.com">send me an email</a> to participate in the alpha program.</blockquote>
<br>
